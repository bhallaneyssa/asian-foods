  ...
  var e = {
    ...
    g = (function () {
      function a(a) {
        ...
        3 == a.length
          ? ((c[0] = a.charAt(0) + a.charAt(0)),
            (c[1] = a.charAt(1) + a.charAt(1)),
            (c[2] = a.charAt(2) + a.charAt(2)))
          : ((c[0] = a.substring(0, 2)),
            (c[1] = a.substring(2, 4)),
            (c[2] = a.substring(4)));
      ...
      if (b) {
        ...
        return (
          a.each(this.spinners, function (d, f) {
            f &&
              (e.isElement(b) ? f.element == b : a(f.element).is(b)) &&
              c.push(f);
          }),
          c
        );
    ...
    removeDetached: function () {
      a.each(
        ...
        a.proxy(function (a, b) {
          b &&
            b.element &&
            !e.element.isAttached(b.element) &&
    ...
    a.extend(d.prototype, {
      setOptions: function (b) {
        (this.options = a.extend({}, this.options, b || {})),
          ...
          this.options.dashWidth &&
            (this.options.width = this.options.dashWidth),
          this.options.speed &&
            (this.options.duration = 1e3 * this.options.speed);
        var b = this._state,
          c = this._position;
        (this._layout = null),
          this.build(),
          c &&
            c >= this.options.dashes - 1 &&
      ...
      _nextPosition: function () {
        ...
        this.nextPosition(),
          (this._playTimer = window.setTimeout(
            a.proxy(this._nextPosition, this),
            b
          ));
      },
      ...
      _pause: function () {
        this._playTimer &&
          (window.clearTimeout(this._playTimer), (this._playTimer = null));
      },
      stop: function () {
        ...
        return (this._layout = b =
          {
            ...
            dash: {
              position: { top: f - e, left: f - c / 2 },
              dimensions: { width: c, height: e - d },
            },
          });
      },
      center: function () {
        var b = 2 * this.getLayout().workspace.radius;
        a(this.element.parentNode).css({ position: "relative" }),
          a(this.element).css({
            position: "absolute",
            height: b + "px",
            width: b + "px",
