    ...
    2: [
      function (require, module, exports) {
        ...
        function toggleElement(el) {
          ...
          var conditions = show
            ? el.getAttribute("data-show-if").split(":")
            : el.getAttribute("data-hide-if").split(":");
          var fieldName = conditions[0];
          var expectedValues = (
            conditions.length > 1 ? conditions[1] : "*"
          ).split("|");
          ...
          for (var i = 0; i < values.length; i++) {
            ...
            conditionMet =
              expectedValues.indexOf(value) > -1 ||
              (expectedValues.indexOf("*") > -1 && value.length > 0);
          ...
          [].forEach.call(inputs, function (el) {
            if (
              (conditionMet || show) &&
              el.getAttribute("data-was-required")
            ) {
              el.required = true;
        ...
        function handleInputEvent(evt) {
          if (
            !evt.target ||
            !evt.target.form ||
            evt.target.form.className.indexOf("mc4wp-form") < 0
          ) {
            return;
          }
