    ...
    function BarRating() {
      ...
      var findInitialOption = function () {
        ...
        if (self.options.initialRating) {
          option = $(
            'option[value="' + self.options.initialRating + '"]',
            self.$elem
          );
        } else {
      ...
      var saveDataOnElement = function () {
        ...
        self.$elem.data("barrating", {
          ...
          currentRatingText: $opt.data("html")
            ? $opt.data("html")
            : $opt.text(),

          // rating will be restored by calling clear method
          originalRatingValue: $opt.val(),
          originalRatingText: $opt.data("html")
            ? $opt.data("html")
            : $opt.text(),
        });

        // first OPTION empty - allow deselecting of ratings
        self.$elem.data("barrating").deselectable = !self.$elem
          .find("option:first")
          .val()
          ? true
          : false;
      ...
      var attachClickHandler = function ($all) {
        $all.on("click", function (event) {
          ...
          if (
            $a.hasClass("br-current") &&
            self.$elem.data("barrating").deselectable
          ) {
            $a.removeClass("br-selected br-current")
              [nextAllorPreviousAll()]()
      ...
      this.set = function (value) {
        ...
        this.$elem.data("barrating").currentRatingText = this.$elem
      ...
      this.clear = function () {
        ...
        this.$elem.data("barrating").currentRatingValue =
          this.$elem.data("barrating").originalRatingValue;
        this.$elem.data("barrating").currentRatingText =
          this.$elem.data("barrating").originalRatingText;
